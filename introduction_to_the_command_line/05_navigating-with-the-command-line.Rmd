...
The top-most directory in your computer is called the *root*. Unix systems denote 
it with the `/` character. It's like the trunk of a tree: every directory in your 
...
or directory. This is useful if you're far away from `root`, or if, in a coding 
